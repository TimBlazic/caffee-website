...
export default function DesktopSocials() {
  ...
  return (
    <ul className="hidden md:flex md:justify-between w-full">
      <li>
        <p className="font-semibold text-[clamp(16px,1.6vw,24px)] text-[#3C2415] py-2">
          ©2025
        </p>
      </li>
        ...
        <li key={social.title}>
          ...
          >
            ...
            <div
              ...
              } absolute -top-48 w-[300px] h-[180px] p-2 rounded-lg bg-[#D2B48C]/80 backdrop-blur-md opacity-0 translate-y-4 scale-95 pointer-events-none group-hover:scale-100 group-hover:translate-y-0 group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-300 z-10`}
            >
              <video
                ref={(el) => {
            ...
            >
              <div className="flex flex-col transition-transform duration-200 ease-[cubic-bezier(0.64,0.57,0.67,1.53)] group-hover:-translate-y-1/2">
                <span className="font-semibold text-[clamp(16px,1.6vw,24px)] text-[#3C2415] mb-1.5">
                  {social.title}
                </span>
                <span className="font-semibold text-[clamp(16px,1.6vw,24px)] text-[#3C2415] mb-1.5">
                  {social.title}
